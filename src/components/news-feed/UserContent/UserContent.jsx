      ...
      <div className="news-feed-user-content">
        <div className="parent-news-feed-create-event-container">
          <div className="child-news-feed-create-event-container">
            <h2 className="news-feed-create-event-container-title">
          ...
          <div className="parent-news-feed-create-business-img-box">
            <div className="child-news-feed-create-business-img-box">
              <Image
                height={100}
                width={100}
                src="https://d19rpgkrjeba2z.cloudfront.net/static/images/offers/blocks-image-open-sign-2.svg"
                className="news-feed-create-business-img"
                alt="Neighborhood Node creat a business page"
              />
            </div>
          </div>
          <div className="news-feed-create-business-title-container">
            <h2 className="news-feed-create-business-title">
              Own a local business?
            </h2>
            <p className="news-feed-create-business-description">
              Create a business page to connect with neighbors, post updates in
              the feed, and gain new customers.
            </p>
          ...
          <div className="child-news-feed-neighbors-reccomendations-container">
            <div className="grandchild-news-feed-neighbors-reccomendations-container">
              <div className="news-feed-neighbors-reccomendations-title-container">
                <h2 className="news-feed-neighbors-reccomendations-title">
                ...
                <div className="child-single-neighbor-reccomendation-container">
                  <div className="single-neighbor-reccomendation-avatar-container">
                    <Image
                      height={100}
                      width={100}
                      className="single-neighbor-reccomendation-avatar"
                      src="https://d19rpgkrjeba2z.cloudfront.net/67d1cbcd8400bb59/static/nextdoorv2/images/avatars/color-24/e.png"
                      alt="profile"
                    />
                  </div>
                  <div className="parent-single-neighbor-reccomendation-info-container">
                    <div className="child-single-neighbor-reccomendation-info-container">
                      <div className="single-neighbor-reccomendation-name-container">
                        <h2 className="single-neighbor-reccomendation-name">
                          Em G.
                        </h2>
                      </div>
                      <div className="single-neighbor-reccomendation-neighborhood-container">
                        <svg
                          className="single-neighbor-reccomendation-neighborhood-icon"
                          width="16"
                          height="16"
                          fill="none"
                          viewBox="0 0 24 24"
                ...
                <div className="child-single-neighbor-reccomendation-container">
                  <div className="single-neighbor-reccomendation-avatar-container">
                    <Image
                      ...
                      width={100}
                      className="single-neighbor-reccomendation-avatar"
                      src="https://d19rpgkrjeba2z.cloudfront.net/ef463cfd00bd71be/static/nextdoorv2/images/avatars/color-11/s.png"
                      alt="profile"
                    />
                  </div>
                  <div className="parent-single-neighbor-reccomendation-info-container">
                ...
                <div className="child-single-neighbor-reccomendation-container">
                  <div className="single-neighbor-reccomendation-avatar-container">
                    <Image
                      ...
                      width={100}
                      className="single-neighbor-reccomendation-avatar"
                      src="https://d19rpgkrjeba2z.cloudfront.net/ef463cfd00bd71be/static/nextdoorv2/images/avatars/color-10/j.png"
                      alt="profile"
                    />
                  </div>
                  <div className="parent-single-neighbor-reccomendation-info-container">
